...
public class TicTacToe extends AbstractGame implements Game {
    ...
    public boolean isValid(int index){
        ...
        for (int i=0; i<3; i++){
            for (int j=0; j<3; j++){
                ...
                if (index == this.tab_index[i][j] && this.tab[i][j] == second_player){
                    return false;
                }
            }
        }
    ...
    public boolean wins(){
        ...
        if (checkWin(this.tab[0][0], this.tab[1][1], this.tab[2][2]) || (checkWin(this.tab[0][2], this.tab[1][1], this.tab[2][0]))){
            return true;
        }
